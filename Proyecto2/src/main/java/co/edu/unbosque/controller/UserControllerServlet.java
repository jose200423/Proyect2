...
public class UserControllerServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (status) {
			...
			RequestDispatcher rd = req.getRequestDispatcher("indexPsicologo.jsp");
			rd.forward(req, resp);
		} else if (statusa) {
			RequestDispatcher rd = req.getRequestDispatcher("indexAlcoholicos.jsp");
			rd.forward(req, resp);
		} else if (statusser) {
			RequestDispatcher rd = req.getRequestDispatcher("indexServicios.jsp");
			rd.forward(req, resp);
		} else {
